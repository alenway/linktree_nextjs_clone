...
function LinkCard({
  ...
  return (
    <a
      href={href}
      className="flex items-center p-1 rounded-md w-5/6 hover:scale-105 transition-all border border-gray-300 mb-3 bg-gray-200 max-w-3xl"
    >
      <div className="flex text-center w-full">
        ...
        <h2 className="flex justify-center items-center -ml-10 font-semibold w-full text-center">
          {title}
        </h2>
      </div>
    </a>
